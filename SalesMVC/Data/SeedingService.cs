...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Antonio Francisco", "antonio.f@gmail.com", new DateTime(1987, 08, 21), 1400.0, d1);
            Seller s4 = new Seller(4, "Pedro Paulo", "pedro.p@gmail.com", new DateTime(1985, 07, 21), 1300.0, d2);
            Seller s5 = new Seller(5, "Paulo Jose", "paulo.j@gmail.com", new DateTime(1993, 06, 21), 1200.0, d3);
            Seller s6 = new Seller(6, "Pedro Jose", "pedro.j@gmail.com", new DateTime(1991, 05, 21), 1100.0, d4);
